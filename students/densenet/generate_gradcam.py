"""
Generate Grad-CAM heatmaps for teacher (ResNet-50), KD student (DenseNet-121),
and baseline student (DenseNet-121) on 200 stratified test images from ImageNette.
...
def load_densenet(ckpt_path) -> nn.Module:
...
def main() -> None:
    ...
    # Target layer: last dense block before transition + global pooling
