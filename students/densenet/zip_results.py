"""
Zip students/densenet/results/ for download.
On Kaggle: writes to /kaggle/working/densenet_results.zip (visible in Output panel).
Locally:   writes to the project root.

Usage (from any directory):
    python students/densenet/zip_results.py
"""
import shutil
