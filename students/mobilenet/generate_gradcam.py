"""
Generate Grad-CAM heatmaps for teacher (ResNet-50), KD student (MobileNetV2),
and baseline student (MobileNetV2) on 200 stratified test images from ImageNette.
...
def load_mobilenet(ckpt_path) -> nn.Module:
...
def main() -> None:
    ...
    kd_student = load_mobilenet(CKPT_KD)
    baseline   = load_mobilenet(CKPT_BASELINE)

    # Target layer: last feature block before global average pooling
