...
_CKPT_SEED42_KAGGLE = Path("/kaggle/input/datasets/mustafaalbaree/kd-attention-checkpoints-mobilenet/mobilenet_baseline.pth")
_CKPT_SEED42_LOCAL  = _HERE / "checkpoints" / "mobilenet_baseline.pth"
