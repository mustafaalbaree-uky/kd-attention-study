...
_CKPT_SEED42_KAGGLE = Path("/kaggle/input/datasets/mustafaalbaree/kd-attention-checkpoints/resnet18_baseline.pth")
_CKPT_SEED42_LOCAL  = _HERE / "checkpoints" / "resnet18_baseline.pth"
